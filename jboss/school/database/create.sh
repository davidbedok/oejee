...
psql -d schooldb -h localhost -p 5432 -U postgres -f create-schema.sql
psql -d schooldb -h localhost -p 5432 -U postgres -f grant-access.sql
psql -d schooldb -h localhost -p 5432 -U postgres -f initial-data.sql