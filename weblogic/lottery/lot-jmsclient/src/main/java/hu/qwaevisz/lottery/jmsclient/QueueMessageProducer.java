...
public class QueueMessageProducer {
	...
	private static final Logger LOGGER = Logger.getLogger(QueueMessageProducer.class.getName());

	private static final String INITIAL_CONTEXT_FACTORY = "weblogic.jndi.WLInitialContextFactory";
	private static final String CONNECTION_FACTORY = "jms/demoConnectionFactory";
