...
public class MagazineController extends HttpServlet implements MagazineParameter, MagazineAttribute {
	...
	private static final Logger LOGGER = Logger.getLogger(MagazineController.class);
	...
	private void forward(final HttpServletRequest request, final HttpServletResponse response, final boolean editFlag, final MagazineStub book, boolean isNew)
